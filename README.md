...
- Animated hero section with a sliding-window canvas reveal of my name
- Terminal-style skills section (`ls languages/`, `ls web/`, etc.)
- Project cards for **HumanCheck** (Chrome extension for bot detection) and **ReadCycle** (community book exchange)
- Typewriter-effect creative writing section
- Achievements timeline (hackathon wins + writing competition)
- Fully responsive, no frameworks — pure HTML/CSS/JS
## Tech Stack
